...
$sql = "select * from keepnotes.stickynotes where id = '$id'";
...
// submitform
 ...
 if (isset($_POST['submit'])) {
    ...
    // update query
    $sql = "update keepnotes.stickynotes set
   title = '$title',
   msg = '$msg'
   where id  = '$id'";
        ...
        <div class="card p-3 mt-5">
            ...
            <form  action="#" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" placeholder="Enter Your Title"   name="title" required><?php echo$title?></textarea> 
                </div>
